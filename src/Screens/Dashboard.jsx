    ...
    <>
      ...
      <View style={styles.data_cards}>
        <CardLinearDefault style={styles.card_data}>
          <Text style={[styles.card_data_number, typography.heading1]}>0</Text>
        ...
        <CardLinearDefault style={styles.card_data}>
          <Text style={[styles.card_data_number, typography.heading1]}>13</Text>
          <Text style={[styles.card_data_heading, typography.body]}>
            Ad Blocked
          </Text>
        </CardLinearDefault>
        ...
        <CardLinearDefault style={styles.card_data}>
          <Text style={[styles.card_data_number, typography.heading1]}>6</Text>
          <Text style={[styles.card_data_heading, typography.body]}>
            Unwanted QR Codes
          </Text>
        </CardLinearDefault>
        ...
        <CardLinearDefault style={styles.card_data}>
          <Text style={[styles.card_data_number, typography.heading1]}>1</Text>
          <Text style={[styles.card_data_heading, typography.body]}>
            Phishing / Scam
          </Text>
        </CardLinearDefault>
